 ...
 * AmpFreteModalidade
 *
 * @ORM\Table(name="amp_frete_modalidade", uniqueConstraints={@ORM\UniqueConstraint(name="descricao_UNIQUE", columns={"descricao"})})
 * @ORM\Entity
 */
class AmpFreteModalidade
{
    /**
     * @var int
     *
     * @ORM\Column(name="id_frete_modalidade", type="integer", nullable=false)
     * @ORM\Id
