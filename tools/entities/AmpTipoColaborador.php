 ...
 * AmpTipoColaborador
 *
 * @ORM\Table(name="amp_tipo_colaborador")
 * @ORM\Entity
 */
class AmpTipoColaborador
{
    /**
     * @var int
     *
     * @ORM\Column(name="id_tipo_colaborador", type="integer", nullable=false)
     * @ORM\Id
