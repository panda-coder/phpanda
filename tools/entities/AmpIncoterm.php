...
class AmpIncoterm
{
     ...
     * @var string
     *
     * @ORM\Column(name="amp_incontermcol", type="string", length=45, nullable=true)
     */
    private $ampIncontermcol;
     ...
     * Set ampIncontermcol
     *
     * @param string $ampIncontermcol
     *
     * @return AmpIncoterm
     */
    public function setAmpIncontermcol($ampIncontermcol)
    {
        $this->ampIncontermcol = $ampIncontermcol;
     ...
     * @return string
     */
    public function getAmpIncontermcol()
    {
        return $this->ampIncontermcol;
    }
}
